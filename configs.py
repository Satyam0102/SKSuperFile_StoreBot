...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002206605982"))
	BOT_OWNER = os.environ.get("BOT_OWNER", "1445283714")
	DATABASE_URL = os.environ.get("DATABASE_URL")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002206605982")
...
│
├🔸👨‍💻 **Developer:** [Sᴀᴛ֟፝ʏꫝᴍ ⚡](https://t.me/Satyam_x2) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/Dotmoviesflix)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/Dotmoviesflix)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [Sᴀᴛ֟፝ʏꫝᴍ ⚡](https://t.me/Satyam_x2) 
